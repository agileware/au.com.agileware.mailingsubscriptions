 ...
 */
class CRM_Mailingsubscriptions_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Mailingsubscriptions_Upgrader(
        'au.com.agileware.mailingsubscriptions',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Mailingsubscriptions_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
